...
namespace Novorfay
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<Novorfay.Data.ConDataContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("ConDataConnection"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ApplicationIdentityDbContext identityDbContext)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                oDataBuilder.EntitySet<Novorfay.Models.ConData.Product>("Products");
                oDataBuilder.EntitySet<Novorfay.Models.ConData.ProductCategory>("ProductCategories");
