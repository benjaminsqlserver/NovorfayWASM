...
namespace Novorfay.Pages
{
    public partial class AddProductCategoryComponent : ComponentBase
    {
        ...
        {
            productcategory = new Novorfay.Models.ConData.ProductCategory(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(Novorfay.Models.ConData.ProductCategory args)
        {
            try
            {
                var conDataCreateProductCategoryResult = await ConData.CreateProductCategory(productCategory:productcategory);
